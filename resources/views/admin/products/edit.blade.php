          ...
          <div class="card mb-9">
            ...
            <div class="card-body">
              <div>
                ...
                <input
                  type="text"
                  class="form-control" name="name" value="{{$products->name}}"
                ...
                <input
                  type="text"
                  class="form-control" name="price" value="{{$products->price}}"
                  id="defaultFormControlInput"
                ...
                <input
                  type="text"
                  class="form-control" name="description" value="{{$products->description}}"
                  id="defaultFormControlInput"
                ...
                <select class="form-select" name="category_id" aria-label="Default select example">
                  ...
                  <option value="{{$products->categories->category_id}}">{{$products->categories->name}}</option>
